...
// * A BeanPostProcessor creates a proxy around the original ZuulHandlerMapping bean. 
// * The proxy intercepts the invocation of the lookupHandler method preventing the execution of the code leading to NoSuchMethodError
// * */
//@Configuration
